export const zhCN = {
  ...
  hero: {
    ...
    cta: "获取体验版",
    note: "支持 Android、macOS；iPhone 版本即将开放。",
  },
  nav: {
    why: "为什么是 PhotoTend",
    workflow: "如何使用",
  ...
  imports: {
    ...
    ariaLabel: "支持的导入来源",
    sources: ["手机系统相册", "相机与存储卡", "移动存储设备", "macOS 文件夹"],
  },
  features: {
    kicker: "从一小段回忆开始",
    items: [
  ...
  platforms: {
    ...
    title: "在熟悉的设备上开始。",
    items: [
      { name: "Android 体验版", status: "正在开放", tone: "ready" },
      { name: "macOS 体验版", status: "正在开放", tone: "ready" },
      { name: "iPhone 即将开放", status: "加入等待名单", tone: "waiting" },
    ],
  },
  finalCta: {
    title: "从下一张照片开始。",
    body: "留下邮箱，我们会把适合你设备的体验方式发送给你。",
    cta: "获取体验版",
    privacy: "只发送测试邀请、下载方式和重要版本通知。你可以随时退订。",
  },
  footer: {
